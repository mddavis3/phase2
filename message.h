...
struct mailbox {
   ...
   //mailbox slot_ptr will point to the first message sent to the mailbox (used for linked list) - REVIEW  
   //int keep track of how many slots are being used - REVIEW 
